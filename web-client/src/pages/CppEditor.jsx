...
import MonacoCppEditor from "../components/MonacoEditor"
import "../App.css"
...
int main() {
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      <h1 className="text-3xl font-extrabold mb-6 text-center bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">C++ Code Editor</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 h-[70vh]">
        ...
        <div className="flex-1 flex flex-col bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-lg shadow-lg overflow-hidden min-w-[300px] min-h-[300px] resize-x">
          <div className="p-2 bg-gradient-to-r from-blue-400 to-purple-400 text-white font-bold text-center">C++ Input</div>
          {/* <textarea
            ...
            spellCheck={false}
          /> */}
          <MonacoCppEditor code={code} setCode={setCode}
            className="flex-1 w-full p-3 font-mono text-base border-0 outline-none bg-transparent focus:bg-white focus:ring-2 focus:ring-blue-400 transition-all duration-200 overflow-auto resize-none"
            style={{ minHeight: 0 }}
            spellCheck={false}
          />
